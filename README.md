...
1. [Counting Words With a Given Prefix](Easy/countingWordsWithAGivenPrefix.go)
1. [Day of the Week](Easy/dayOfTheWeek.go)
1. [Height Checker](Easy/heightChecker.go)
1. [Maximum Count of Positive Integer and Negative Integer](Easy/MaximumCountOfPositiveAndNegativeInteger.go)
1. [Count Negative Numbers in a Sorted Matrix](Easy/countNegativeNumbersInASortedMatrix.go)
1. [Single Number](Easy/singleNumber.go)
1. [Remove Duplicates from Sorted Array](Easy/removeDuplicatesFromSortedArray.go)
1. [Is Subsequence](Easy/isSubsequence.go)
1. [How Many Numbers Are Smaller Than the Current Number](Easy/smallerNumbersThanCurrent.go)
...
1. [Single Number III](Medium/singleNumberIII.go)
1. [Single Number II](Medium/singleNumberII.go)
1. [Majority Element II](Medium/majorityElementII.go)
